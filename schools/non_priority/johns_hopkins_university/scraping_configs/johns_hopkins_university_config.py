...
config = SpiderConfig(
    name="jhu",
    start_url="https://e-catalogue.jhu.edu/course-descriptions/",
    ...
    tasks=[
        Find(
            task_name="courses",
            search_space='xpath://div[@class="sc_coursedescsbysubjcode"]',
            repeating_selector="div",
            fields={
                "title": 'xpath:div[@class="cols noindent"]/span/strong//text()join',
